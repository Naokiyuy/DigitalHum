...
function updateDisplayOrder(id){
	window.location.href = "/backend/item-updorder.do?action=${action}&id=" + id + "&displayOrder=" + $('#displayOrder').val();
}
</script>
<hr />
<div id="top_bar">
...
<div id="hotnews-list-table">
	...
	<div class="hotnews-list-tr">
		...
		<div class="hotnews-list-td">
			<input type="text" id="displayOrder" name="displayOrder" value="${item.displayOrder}" size="2"/>&nbsp;
