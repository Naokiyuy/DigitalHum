...
<div id="hotnews-list-table">
	...
	<div class="hotnews-list-tr">
		...
		<div class="hotnews-list-td"><a href="/backend/hotnews-view.do?hotnews_id=${hotnews.id}">${hotnews.id}</a></div>
		...
		<div class="hotnews-list-td">
			<section>
				<div id="container_buttons">
					<p>
						<a class="function_btn" href="/backend/hotnews-view.do?hotnews_id=${hotnews.id}">編輯</a>
					</p>
					<p>
						<a class="function_btn delete_btn" href="#" onclick="deleteItem(${hotnews.id});return false;">刪除</a>
					</p>
				</div>
			</section>
		</div>
